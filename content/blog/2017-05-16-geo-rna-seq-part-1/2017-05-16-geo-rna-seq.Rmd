...
```{r pubdiff, fig.cap="Length of timeperiod between publication of GEO HT-sequencing dataset and article describing the study. Left, distribution of timeperiods. Right, scatterplot of dataset versus article publication dates."}
library(grid)
library(gridExtra)
