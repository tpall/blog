...
$$y_{ij} \sim N(\mu + \alpha_j, \sigma_y)$$ *i=1,...,n_j*, *j=1,...,J*  
$$\alpha_j \sim N(0, \sigma_\alpha)$$ *j=1,...,J*
...
$$y_{ij} \sim N(\mu + \tau \times \eta_j, \sigma_y)$$ *i=1,...,n_j*, *j=1,...,J*  
$$\eta_j \sim N(0, \sigma_eta)$$ *j=1,...,J*
